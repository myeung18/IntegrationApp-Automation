...
oc new-app -f cicd-3scale/3scaletoolbox/pipeline-template.yaml -p IMAGE_NAMESPACE=$DEV_PROJECT -p DEV_PROJECT=$DEV_PROJECT -p TEST_PROJECT=$TEST_PROJECT -p PROD_PROJECT=$PROD_PROJECT  -p PUBLIC_PRODUCTION_WILDCARD_DOMAIN=apps.mw-ocp4.cloud.lab.eng.bos.redhat.com -p PUBLIC_STAGING_WILDCARD_DOMAIN=staging.apps.mw-ocp4.cloud.lab.eng.bos.redhat.com -p DEVELOPER_ACCOUNT_ID=developer
